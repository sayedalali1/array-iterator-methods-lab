...
// Enter your solution code here:
// const years = [inventors.year];
// years.sortedByBirthYear(years);
...
const inventorNamedAda = inventors.find(findAda =>{
    return findAda.first === 'Ada'
})
...
isAdultPresent = devs.some( age => {
  return 2024 - age.year ;
})
...
isEveryone19OrOlder = people.every( age =>{
  return 2024-age.year > 19;
})
